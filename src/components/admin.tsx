  ...
  return (
    <div className="flex flex-col min-h-screen ">
      ...
      <div className="mt-4 md:mt-0 md:flex px-3 md:px-0 space-y-6 md:space-y-0 h-[90vh] md:justify-around items-center ">
        <div className="sm:w-full md:w-[50vw] h-[50vh] px-3 md:px-0 flex border border-blue-900 bg-blue-500 justify-center items-center text-5xl text-slate-50 rounded-lg shadow-2xl ">
          <h3>Client User and Admin Content</h3>
        </div>
        <div className=" sm:w-full md:w-[40vw] h-[50vh] px-3 md:px-0 flex border border-blue-900 bg-blue-500 justify-center items-center text-5xl text-slate-50 rounded-lg shadow-2xl ">
